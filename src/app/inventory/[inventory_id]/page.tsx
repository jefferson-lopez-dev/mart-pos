          ...
          <ActionPanel
            ...
            preferences={{
              ...
              buttonPrimary: {
                render: true,
                icon: "Settings",
                route: `/inventory/${params.inventory_id}/configuration`,
              },
              buttonSecondary: {
                render: true,
                route: `/inventory/${params.inventory_id}/folder/new`,
                text: "Create Folder",
              },
              iconTitle: {
                render: true,
                  ...
                  folders.map((folder: any, i: any) => {
                    return (
                      <Button
                        onClick={() => {
                          push(
                            `/inventory/${params.inventory_id}/folder/${folder.uuid}`
                          );
                        }}
                        variant="ghost"
                      ...
                      >
                        <div className="flex items-center w-full justify-start gap-2">
                          <div className="flex items-center justify-center text-neutral-500">
                            <Folder className="text-black fill-black dark:fill-white dark:text-white" />
                          </div>
                          <p>{folder.name}</p>
                        </div>
                        <div></div>
